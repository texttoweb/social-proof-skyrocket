    ...
    <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-guests" role="tabpanel" aria-labelledby="pills-guests-tab">
            ...
            <div class="form-group">
                ...
                <input id="guests_text_color" type="hidden" name="guests_text_color" class="form-control form-control-lg" value="<?= settings()->announcements->guests_text_color ?>" data-color-picker />
            </div>

            <div class="form-group">
                <label for="guests_background_color"><?= l('admin_settings.announcements.background_color') ?></label>
                <input id="guests_background_color" type="hidden" name="guests_background_color" class="form-control form-control-lg" value="<?= settings()->announcements->guests_background_color ?>" data-color-picker />
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="pills-users" role="tabpanel" aria-labelledby="pills-users-tab">
            ...
            <div class="form-group">
                ...
                <input id="users_text_color" type="hidden" name="users_text_color" class="form-control form-control-lg" value="<?= settings()->announcements->users_text_color ?>" data-color-picker />
            </div>

            <div class="form-group">
                <label for="users_background_color"><?= l('admin_settings.announcements.background_color') ?></label>
                <input id="users_background_color" type="hidden" name="users_background_color" class="form-control form-control-lg" value="<?= settings()->announcements->users_background_color ?>" data-color-picker />
            </div>
        </div>
    </div>
</div>
