...
<div>
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            <input id="auto_delete_unconfirmed_users" type="number" min="0" name="auto_delete_unconfirmed_users" class="form-control form-control-lg" value="<?= settings()->users->auto_delete_unconfirmed_users ?>" />
